...
var crawler = function(options) {
    ...
    self.request = function(item, callback) {
      self.queue(item, callback, false);
    }


    self.queue = function (item, callback, overridecb) {

      if(typeof(overridecb) === "undefined" && typeof(callback) !== "undefined") {
